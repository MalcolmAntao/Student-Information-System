...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Validate input
    if (empty($firstName) || empty($lastName) || empty($rollNumber) || empty($universityID) || empty($email)) {
    ...
    try {
        ...
        if ($stmt->execute()) {
            echo "Student details successfully added!";
        } else {
            echo "Error occurred while adding student details.";
        }
