...
$query = "SELECT Content, Posting_Date FROM announcements ORDER BY Posting_Date DESC LIMIT 10";
            ...
            <div class="column-2">
                ...
                <div class="courses gradient-card">
                    <div class="course-card ">
                        ...
                        <div class="course-marks gradient-bg-hover">
                            <a href="../PHP/NewEntry(T)2.php">
                                <strong>Click to add new Teacher</strong>
                            </a>
                        </div>
                    </div>
                    <div class="course-card ">
                        ...
                        <!-- Marks Info Card (Initially hidden) -->
                        <div class="course-marks gradient-bg-hover">
                            <a href="../PHP/NewEntry(S)2.php">
                                <strong>Click to add new Student</strong>
                            </a>
                        </div>
                    </div>
                </div>
                <div class="courses gradient-card">
                    <div class="course-card ">
                        ...
                        <div class="course-marks gradient-bg-hover">
                            <a href="../PHP/NewTeacherAccess.php">
                                <strong>Click to edit Teacher details</strong>
                            </a>
                        </div>
                    </div>
                    <div class="course-card ">
                        ...
                        <div class="course-marks gradient-bg-hover">
                            <a href="../PHP/NewStudentAccess.php">
                                <strong>Click to edit Student details</strong>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="column-3">
                ...
                <div class="small-block gradient-card">
                    <div class="course-card">
                        <!-- Basic Info Card -->
                        <div class="course-basic">
                            <a href="../PHP/NewNotices.php" style="text-decoration: none; color:#ffffff">
                                <h3><em>Notices</em></h3>
                            </a>
                        </div>
                        <!-- Marks Info Card (Initially hidden) -->
                        <div class="course-marks">
                            <a href="../PHP/NewNotices.php" style="text-decoration: none; color:#ffffff">
                                <?php if (!empty($notices)): ?>
                                    <ul style="padding: 0; margin: 0; color: #ffffff;">
                                        <?php foreach ($notices as $notice): ?>
                                            <li><strong style="color: #fff;"><?= htmlspecialchars($notice['Content']) ?></strong></li>
                                        <?php endforeach; ?>
                                    </ul>
                                <?php else: ?>
                                    <strong style="color: #fff;">No recent notices available.</strong>
                                <?php endif; ?>
                            </a>
                        </div>
                    </div>
