...
$query = "SELECT Announcement_ID, Title, Content, Posting_Date, Author_ID FROM announcements";
...
<style>
    ...
    * {
    ...
    .announcement-content:hover::after {
        content: attr(data-full-content);
        /* Show full content on hover */
        position: absolute;
        left: 0;
    ...
    /* Responsive adjustments for light mode */
    body.light-mode .announcement-table {
        background-color: #e0e0e0;
        color: #000;
    }

    body.light-mode .announcement-table th {
        background-color: #d0d0d0;
    }

    body.light-mode .announcement-table td {
        background-color: #c0c0c0;
    }

    body.light-mode .announcement-content:hover::after {
        background-color: #f0f0f0;
        color: #000;
    }
</style>
                                        ...
                                        <?php if ($announcements): ?>
                                            <?php foreach ($announcements as $announcement): ?>
                                                <tr>
                                                    ...
                                                    <td class="announcement-content" data-full-content="<?= htmlspecialchars($announcement['Content']) ?>">
                                                        <?= htmlspecialchars(substr($announcement['Content'], 0, 50)) ?>...
                                                    </td>
                                                    <td><?= htmlspecialchars($announcement['Posting_Date']) ?></td>
                                                    <td><?= htmlspecialchars($announcement['Author_ID']) ?></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php else: ?>
                                            <tr>
